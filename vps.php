...
<title>VelocityHost | VPS Hosting</title>
<meta name="description" content="Host your VPS servers with VelocityHost — full root access, low latency, high performance, and enterprise DDoS protection.">
<meta name="keywords" content="VPS Hosting, Virtual Private Server, Windows VPS, Linux VPS, DDoS Protected VPS, VelocityHost, High Performance Servers">
<meta name="author" content="VelocityHost.tn">
<link rel="canonical" href="https://velocityhost.tn/vps.php">

<!-- Open Graph / Facebook -->
<meta property="og:site_name" content="VelocityHost">
<meta property="og:title" content="VelocityHost | VPS Hosting">
<meta property="og:description" content="Reliable VPS hosting with full control, instant deployment, and secure, fast servers for all your hosting needs.">
<meta property="og:type" content="website">
<meta property="og:locale" content="en_US">
<meta property="og:url" content="https://velocityhost.tn/vps.php">
<meta property="og:image" content="https://velocityhost.tn/assets/imgs/hero.webp">

<!-- Twitter -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="VelocityHost | VPS Hosting">
<meta name="twitter:description" content="High-performance VPS hosting with instant setup and DDoS protection. Full root access and dedicated resources.">
...
<header class="max-w-6xl mx-auto px-6 pt-32 pb-20 relative">
  <div class="grid md:grid-cols-2 gap-8 items-center">
    <div class="enter-up">
      <small class="text-sky-300/70 font-medium uppercase tracking-wide">VPS Hosting</small>
      <h1 class="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
        Fast & Reliable <span style="background:linear-gradient(90deg,var(--accent),var(--accent-2));-webkit-background-clip:text;background-clip:text;color:transparent">VPS Servers</span> — <span class="text-sky-300">Full Root Access & Secure</span>
      </h1>
      <p class="mt-4 text-sky-200/70 max-w-xl">
        High-performance virtual servers with SSD storage, enterprise DDoS protection, and instant setup. Perfect for developers, businesses, and gaming communities.
      </p>

      <div class="mt-6 flex flex-wrap gap-3">
        <a href="#plans" class="inline-flex items-center gap-3 bg-gradient-to-r from-sky-500 to-indigo-500 text-black px-5 py-3 rounded-lg font-semibold shadow-lg">View VPS Plans</a>
      </div>
    ...
    <div class="enter-up">
      <div class="relative glass p-6 rounded-2xl shadow-2xl border border-white/6">
        ...
        <div class="flex items-start gap-4">
          <div>
            <h3 class="text-2xl font-extrabold">VPS Pro</h3>
            <p class="text-sky-200/70 text-sm mt-1">Ideal for medium workloads</p>
          </div>
          <div class="ml-auto text-right">
            <div class="text-xs text-sky-300">Starting at</div>
            <div class="text-4xl font-extrabold">€13.99<span class="text-sm">/mo</span></div>
            <div class="text-xs text-sky-300">or €150/year</div>
          </div>
        </div>

        <ul class="mt-6 space-y-3 text-sm text-sky-200/70">
          <li>✓ 4 vCPU • 12 GB RAM</li>
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-3">
          <a href="https://velocityhost.tn/store/index.php?rp=/store/kvm-vps/pro-plan-12-ram" class="flex-1 text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order VPS Pro</a>
        </div>
      </div>
    </div>
  </div>
...
<section id="plans" class="max-w-6xl mx-auto px-6 py-12">
  <div class="text-center mb-8">
    <h2 class="text-3xl font-extrabold">Choose Your VPS Plan</h2>
  ...
  <div class="grid md:grid-cols-3 gap-6">
    ...
    <div class="glass p-6 rounded-2xl enter-up">
      <div class="flex items-center justify-between">
        <div>
          <h3 class="font-bold text-lg">Starter VPS</h3>
          <p class="text-xs text-sky-200/60">Perfect for beginners</p>
        </div>
        <div class="text-right">
          <div class="text-2xl font-extrabold">€4.99<span class="text-sm">/mo</span></div>
      ...
      <div class="mt-6">
        <a href="https://velocityhost.tn/store/index.php?rp=/store/kvm-vps/starter-plan" class="block text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Starter</a>
      </div>
    </div>
    ...
    <div class="relative glass p-6 rounded-2xl shadow-lg border border-white/6 enter-up">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="font-bold text-lg">Pro VPS</h3>
          <p class="text-xs text-sky-200/60">Recommended for developers</p>
        </div>
        <div class="text-right">
          <div class="text-2xl font-extrabold">€9.99<span class="text-sm">/mo</span></div>
          <div class="text-xs text-sky-300">2 vCPU • 8 GB RAM</div>
        </div>
      </div>
      <ul class="mt-4 text-sm text-sky-200/70 space-y-2">
      ...
      <div class="mt-6 flex flex-col sm:flex-row gap-3">
        <a href="https://velocityhost.tn/store/index.php?rp=/store/kvm-vps/basic-plan-8-ram" class="flex-1 text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Pro</a>
      </div>
    </div>
    ...
    <div class="glass p-6 rounded-2xl enter-up">
      <div class="flex items-center justify-between">
        <div>
          <h3 class="font-bold text-lg">Ultra VPS</h3>
        ...
        <div class="text-right">
          ...
          <div class="text-xs text-sky-300">6 vCPU • 16 GB RAM</div>
        </div>
      </div>
      <ul class="mt-4 text-sm text-sky-200/70 space-y-2">
      ...
      <div class="mt-6">
        <a href="https://velocityhost.tn/store/index.php?rp=/store/kvm-vps/elite-plan-16-ram" class="block text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Ultra</a>
      </div>
    </div>
  </div>
</section>
