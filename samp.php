...
<title>VelocityHost | SAMP Game Server Hosting</title>
<meta name="description"
    content="Host your SAMP (San Andreas Multiplayer) game servers with VelocityHost — low ping, high-performance, and secure servers with full FTP access and DDoS protection.">
<meta name="keywords"
    content="SAMP Hosting, San Andreas Multiplayer, Game Server Hosting, DDoS Protected Hosting, VelocityHost, Multiplayer Game Servers, Low Ping SAMP, Fast SAMP Hosting">
<meta name="author" content="VelocityHost.tn">
<link rel="canonical" href="https://velocityhost.tn/samp.php">

<!-- Open Graph / Facebook -->
<meta property="og:site_name" content="VelocityHost">
<meta property="og:title" content="VelocityHost | SAMP Game Server Hosting">
<meta property="og:description"
    content="Experience smooth and secure SAMP server hosting with VelocityHost. Low ping, full control, and DDoS protection for your multiplayer servers.">
<meta property="og:type" content="website">
<meta property="og:locale" content="en_US">
<meta property="og:url" content="https://velocityhost.tn/samp.php">
<meta property="og:image" content="https://velocityhost.tn/assets/imgs/hero.webp">

<!-- Twitter -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="VelocityHost | SAMP Game Server Hosting">
<meta name="twitter:description"
    content="Host your SAMP servers with VelocityHost — low ping, high-performance, and secure servers with full FTP access and DDoS protection.">
...
<?php include 'includes/navbar.php'; ?>
  ...
  <header class="max-w-6xl mx-auto px-6 pt-32 pb-20 relative">
    <div class="grid md:grid-cols-2 gap-8 items-center">
      <div class="enter-up">
        <small class="text-sky-300/70 font-medium uppercase tracking-wide">SA-MP Hosting</small>
        <h1 class="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">Fast & Reliable <span style="background:linear-gradient(90deg,var(--accent),var(--accent-2));-webkit-background-clip:text;background-clip:text;color:transparent">SA-MP Servers</span> — <span class="text-sky-300">Low ping, instant setup</span></h1>
        ...
        <div class="mt-6 flex flex-wrap gap-3">
          <a href="#plans" class="inline-flex items-center gap-3 bg-gradient-to-r from-sky-500 to-indigo-500 text-black px-5 py-3 rounded-lg font-semibold shadow-lg">View SA-MP Plans</a>
        </div>
      ...
      <div class="enter-up">
        <div class="relative glass p-6 rounded-2xl shadow-2xl border border-white/6">
          ...
          <div class="flex items-start gap-4">
            <div>
              <h3 class="text-2xl font-extrabold">SA-MP Pro</h3>
          ...
          <div class="mt-6 flex flex-col sm:flex-row gap-3">
            <a href="https://velocityhost.tn/store/index.php?rp=/store/sa-mp-server/pro-plan-150-players" class="flex-1 text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Pro</a>
          </div>
  ...
  <section id="plans" class="max-w-6xl mx-auto px-6 py-12">
    <div class="text-center mb-8">
      <h2 class="text-3xl font-extrabold">Choose your SA-MP plan</h2>
    ...
    <div class="grid md:grid-cols-3 gap-6">
      ...
      <div class="glass p-6 rounded-2xl enter-up">
        ...
        <div class="mt-6">
          <a href="https://velocityhost.tn/store/index.php?rp=/store/sa-mp-server/starter-plan-50-players" class="block text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Starter</a>
        </div>
      </div>
      ...
      <div class="relative glass p-6 rounded-2xl shadow-lg border border-white/6 enter-up">
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-3">
          <a href="https://velocityhost.tn/store/index.php?rp=/store/sa-mp-server/basic-plan-100-player" class="flex-1 text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Pro</a>
      ...
      <div class="glass p-6 rounded-2xl enter-up">
        ...
        <div class="mt-6">
          <a href="https://velocityhost.tn/store/index.php?rp=/store/sa-mp-server/elite-plan-1000-players" class="block text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Ultra</a>
          </div>
      </div>
      </section>
