...
<title>VelocityHost | MTA Game Server Hosting</title>
<meta name="description"
    content="Host your MTA (Multi Theft Auto) game servers with VelocityHost — fast, secure, and low-latency servers with full FTP access and DDoS protection.">
<meta name="keywords"
    content="MTA Hosting, Multi Theft Auto, Game Server Hosting, DDoS Protected Hosting, VelocityHost, Multiplayer Game Servers, Low Ping MTA, Fast MTA Hosting">
<meta name="author" content="VelocityHost.tn">
<link rel="canonical" href="https://velocityhost.tn/mta.php">

<!-- Open Graph / Facebook -->
<meta property="og:site_name" content="VelocityHost">
<meta property="og:title" content="VelocityHost | MTA Game Server Hosting">
<meta property="og:description"
    content="Experience high-performance and secure MTA server hosting with VelocityHost. Low ping, full control, and DDoS protection for your multiplayer servers.">
<meta property="og:type" content="website">
<meta property="og:locale" content="en_US">
<meta property="og:url" content="https://velocityhost.tn/mta.php">
<meta property="og:image" content="https://velocityhost.tn/assets/imgs/hero.webp">

<!-- Twitter -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="VelocityHost | MTA Game Server Hosting">
<meta name="twitter:description"
    content="Host your MTA servers with VelocityHost — fast, low-latency, and secure hosting with full FTP access and DDoS protection.">
...
<?php include 'includes/navbar.php'; ?>
  ...
  <header class="max-w-6xl mx-auto px-6 pt-32 pb-20 relative">
    <div class="grid md:grid-cols-2 gap-8 items-center">
      <div class="enter-up">
        <small class="text-sky-300/70 font-medium uppercase tracking-wide">MTA:SA Hosting</small>
        <h1 class="text-4xl md:text-5xl font-extrabold mt-4 leading-tight">Fast & Reliable <span style="background:linear-gradient(90deg,var(--accent),var(--accent-2));-webkit-background-clip:text;background-clip:text;color:transparent">MTA:SA Servers</span> — <span class="text-sky-300">Low ping, instant setup</span></h1>
        <p class="mt-4 text-sky-200/70 max-w-xl">Host your Multi Theft Auto community with pro-grade hardware, 24/7 DDoS protection and a powerful control panel. Optimised for performance and uptime.</p>

        <div class="mt-6 flex flex-wrap gap-3">
          <a href="#plans" class="inline-flex items-center gap-3 bg-gradient-to-r from-sky-500 to-indigo-500 text-black px-5 py-3 rounded-lg font-semibold shadow-lg">View MTA:SA Plans</a>        </div>
      ...
      <div class="enter-up">
        <div class="relative glass p-6 rounded-2xl shadow-2xl border border-white/6">
          ...
          <div class="flex items-start gap-4">
            <div>
              <h3 class="text-2xl font-extrabold">MTA:SA Pro</h3>
          ...
          <div class="mt-6 flex flex-col sm:flex-row gap-3">
            <a href="https://velocityhost.tn/store/index.php?rp=/store/mta-sa-server/pro-plan-150-players-1" class="flex-1 text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Pro</a>
          </div>

          <div class="mt-4 text-xs text-sky-300">Includes <strong>control panel</strong>, FTP access and custom mtaserver.conf support.</div>
        </div>
      </div>
  ...
  <section id="plans" class="max-w-6xl mx-auto px-6 py-12">
    <div class="text-center mb-8">
      <h2 class="text-3xl font-extrabold">Choose your MTA:SA plan</h2>
      ...
      <div class="glass p-6 rounded-2xl enter-up">
        <div class="flex items-center justify-between">
          ...
          <div class="text-right">
            ...
            <div class="text-xs text-sky-300">100 slots</div>
          </div>
        </div>
        ...
        <div class="mt-6">
          <a href="https://velocityhost.tn/store/index.php?rp=/store/mta-sa-server/starter-plan-50-players-1" class="block text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Starter</a>
        </div>
      </div>
      ...
      <div class="relative glass p-6 rounded-2xl shadow-lg border border-white/6 enter-up">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-right">
            ...
            <div class="text-xs text-sky-300">200 slots</div>
          </div>
        </div>
        <ul class="mt-4 text-sm text-sky-200/70 space-y-2">
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-3">
          <a href="https://velocityhost.tn/store/index.php?rp=/store/mta-sa-server/basic-plan-100-player-1" class="flex-1 text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Pro</a>
      ...
      <div class="glass p-6 rounded-2xl enter-up">
        <div class="flex items-center justify-between">
          ...
          <div class="text-right">
            ...
            <div class="text-xs text-sky-300">1000 slots</div>
          </div>
        </div>
        <ul class="mt-4 text-sm text-sky-200/70 space-y-2">
        ...
        <div class="mt-6">
          <a href="https://velocityhost.tn/store/index.php?rp=/store/mta-sa-server/elite-plan-1000-players-1" class="block text-center py-3 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-black font-semibold">Order Ultra</a>
          </div>
      </div>
      </section>
